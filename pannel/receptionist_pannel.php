           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a class="active-menu"  href="receptionist_pannel.php"><i class="fa fa-dashboard fa-3x"></i> Dashboard</a>
                    </li>
                    ...
                    <li>
                       ...
                       <li>
                        <a  href="../forms/transaction.php" target="result"><i class="fa fa-user-md fa-3x"></i>Medicine Transaction</a>
                    </li>
